...
@Entity
@Immutable
@Subselect(VTypeSituationAcademique.QUERY)
public class VTypeSituationAcademique extends BaseEntityForParameterView {
  ...
  public static final String QUERY = """
      SELECT
            ...
            FROM parametrage.academiqueconditiontype t
            LEFT JOIN "members-management".person p ON t.id = p.pkey_type_situation_academique_id

...
@Entity
@Immutable
@Subselect(VSituationMatrimoniale.QUERY)
public class VSituationMatrimoniale extends BaseEntityForParameterView {
  ...
  public static final String QUERY = """
    SELECT
          ...
          FROM parametrage.situationmatrimoniale t
          LEFT JOIN "members-management".person p ON t.id = p.pkey_situationmatrimoniale_id

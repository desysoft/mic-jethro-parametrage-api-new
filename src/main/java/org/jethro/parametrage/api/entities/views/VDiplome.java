...
@Entity
@Immutable
@Subselect(VDiplome.QUERY)
public class VDiplome extends BaseEntityForParameterView {
  ...
  public static final String QUERY = """
    SELECT
          ...
          FROM parametrage.diplome t
          LEFT JOIN "members-management".person p ON t.id = p.pkey_diplome_id

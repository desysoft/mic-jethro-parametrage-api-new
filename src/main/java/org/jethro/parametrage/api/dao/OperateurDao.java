...
@ApplicationScoped
public class OperateurDao extends CommonDao<Operateur> {

    public Operateur save(Operateur ville){
        try {
            LOG.info("save");
    ...
    public Operateur update(String uuid, Operateur villeForUpdate){
        try {
            Operateur villeFind = this.findByIdCustom(uuid);
            if(villeFind==null){
                this.setMessage(ParametersConfig.PROCESS_FAILED);
    ...
    public boolean delete(String uuid){
        Operateur ville = this.findByIdCustom(uuid);
        if(ville==null){
            this.setMessage(ParametersConfig.PROCESS_FAILED);
            this.setDetailMessage(ParametersConfig.genericNotFoundMessage);
            return false;
